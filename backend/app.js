...
const f = new Formula("C{ac}p||r")

const nmodel = new Model(worldset, relationset);

console.log(nmodel.world_check(w0,f))
console.log(nmodel.world_check(w1,f))
console.log(nmodel.world_check(w2,f))
console.log(nmodel.world_check(w3,f))
console.log(nmodel.world_check(w4,f))
console.log(nmodel.world_check(w5,f))
